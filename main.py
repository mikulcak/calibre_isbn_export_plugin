...
__license__ = 'GPL v3'
__copyright__ = '2020, Marcus Mikulcak <marcus.mikulcak@gmail.com>'
__credits__ = 'Kovid Goyal <kovid@kovidgoyal.net>'
...
from PyQt5.Qt import QDialog, QVBoxLayout, QPushButton, QMessageBox, QLabel, QApplication
...
class DemoDialog(QDialog):
    def __init__(self, gui, icon, do_user_config):
        ...
        self.setWindowTitle('Extract ISBN Plugin')
        ...
        self.isbn_clipboard_button = QPushButton('Copy ISBNs to Clipboard',
                                                 self)
        self.isbn_clipboard_button.clicked.connect(self.copy_to_clipboard)
        self.l.addWidget(self.isbn_clipboard_button)
